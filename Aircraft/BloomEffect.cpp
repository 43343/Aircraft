	...
	, mSecondPassTextures()
{
	...
	mShaders.load(Shaders::BrightnessPass, "Shaders/Fullpass.vert", "Shaders/Brightness.frag");
	...
	mShaders.load(Shaders::AddPass, "Shaders/Fullpass.vert", "Shaders/Add.frag");
